  ...
  const fetchOrders = useCallback(async () => {
    ...
    try {
      const { data, error: fetchError } = await supabase
        .from('orders')
        .select('id, order_number, customer_name, customer_email, customer_phone, order_type, status, payment_status, subtotal, payment_method, delivery_fee, delivery_address, notes, pickup_date, pickup_time, created_at, updated_at')
